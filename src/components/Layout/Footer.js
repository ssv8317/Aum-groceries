        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">AUM Groceries</span>
            </div>
            <p className="text-gray-400 mb-4">
              Your trusted partner for fresh groceries delivered right to your doorstep. 
              We bring quality, convenience, and care to every order.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297L3.182 14.3c-.49-.49-.49-1.297 0-1.787s1.297-.49 1.787 0l1.944 1.944c.49.49 1.297.49 1.787 0l7.778-7.778c.49-.49 1.297-.49 1.787 0s.49 1.297 0 1.787l-8.816 8.816c-.875.807-2.026 1.297-3.323 1.297z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 AUM Groceries. All rights reserved.
            </p>
